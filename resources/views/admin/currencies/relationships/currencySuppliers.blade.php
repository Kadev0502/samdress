            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-currencySuppliers">
                            <thead>
                                <tr>
                                    <th width="10">
                            ...
                            <tbody>
                                @foreach($suppliers as $key => $supplier)
                                    <tr data-entry-id="{{ $supplier->id }}">
                                        ...
                                        <td>
                                            @foreach($supplier->currencies as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-currencySuppliers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
