            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-supplierCurrencies">
                            <thead>
                                <tr>
                                    <th width="10">
                                    ...
                                    <th>
                                        {{ trans('cruds.currency.fields.supplier') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
                            ...
                            <tbody>
                                @foreach($currencies as $key => $currency)
                                    <tr data-entry-id="{{ $currency->id }}">
                                        ...
                                        <td>
                                            @foreach($currency->suppliers as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-supplierCurrencies:not(.ajaxTable)').DataTable({ buttons: dtButtons })
