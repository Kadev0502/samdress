                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('supplier_management_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.supplierManagement.title') }}
                                        </a>
                                    @endcan
                                    @can('supplier_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.suppliers.index') }}">
                                    ...
                                    @can('categories_management_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.categoriesManagement.title') }}
                                        </a>
                                    @endcan
                                    @can('category_access')
                                    ...
                                    @can('sub_category_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.sub-categories.index') }}">
                                            {{ trans('cruds.subCategory.title') }}
                                        </a>
                                    @endcan
                                    @can('size_color_management_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.sizeColorManagement.title') }}
                                        </a>
                                    @endcan
                                    @can('color_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.colors.index') }}">
                                            {{ trans('cruds.color.title') }}
                                        </a>
                                    @endcan
                                    @can('size_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.sizes.index') }}">
                                            {{ trans('cruds.size.title') }}
                                        </a>
                                    @endcan
                                    @can('orders_manangement_access')
                                        <a class="dropdown-item disabled" href="#">
                                            {{ trans('cruds.ordersManangement.title') }}
                                        </a>
                                    @endcan
                                    @can('product_access')
